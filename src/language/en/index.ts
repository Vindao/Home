  ...
  Services: {
    ...
    Cards: {
      Hero: {
        ...
        text: `Progressive web applications are a new technology which brings native-like applications
        ...
        img:
          'https://res.cloudinary.com/dhrg3xz0y/image/upload/f_auto/v1588126230/Vindao%20Home/responsive-2044932_zjwjbn.png'
      },
      ...
      Offline: {
        ...
        text: `Through intelligent caching techniques, our applications are fully offline capable. 
        Therefore you will never have a slow experience because of a bad internet connection. 
        After the initial load, a PWA will always load instantly.`,
        img:
          'https://res.cloudinary.com/dhrg3xz0y/image/upload/f_auto/v1588126230/Vindao%20Home/horizon-3332692_y1pec6'
      },
      Installable: {
        id: 3,

        title: 'Installable',
        text: `Like any native application, a PWA can be installed to your system by just one click. 
        After installation the application will be available like all other applications on your device. 
        For instance, you can access the application via you homescreen on your smartphone, or the application launcher on your laptop or desktop PC.`,
        img:
          'https://res.cloudinary.com/dhrg3xz0y/image/upload/f_auto/v1588126230/Vindao%20Home/ehr-1476525_bfq1jt'
      },
      Consistent: {
        id: 4,

        title: 'Consistent User-experiences across all devices',
        text: `Because progressive web applications are based on a single code-base, they are highly consistent across devices. 
        Users can seemlessly switch between devices, and the application will still work and feel almost the same. 
        Sure, there are differences between a mobile screen and the 4K monitor you use on your desktop PC, and the application has to visually change between those devices. 
        But because PWA's are based on a single code-base the application will have a consistent feel across those devices.`,
        img:
          'https://res.cloudinary.com/dhrg3xz0y/image/upload/f_auto/v1588126230/Vindao%20Home/board-1273117_wnotff'
      },
      Discoverable: {
        id: 5,
