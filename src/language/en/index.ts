export default {
  ...
  Home: {
    ...
    paragraph:
      'We are specialized in the creation of progressive web apps. These applications are distributed via the browser, but still offer device specific features.',
    bgImage: {
    ...
    Cards: [
      {
        ...
        image: {
          alt: 'Alle unterschiedlichen Geräte',
