export default {
  ...
  Forms: {
    ...
    acceptPrivacyPolicy: `
      Ik heb kennis genomen van het <nuxt-link to="terms">privacybeleid</nuxt-link>. 
      Ik ga ermee akkoord dat mijn gegevens en gegevens voor het beantwoorden van mijn vraag elektronisch worden verzameld en opgeslagen.
      `,
    privacyPolicyNote: `
      Opmerking: U kunt uw toestemming voor de toekomst te allen tijde intrekken per e-mail aan support@vindao.io.
      `,
