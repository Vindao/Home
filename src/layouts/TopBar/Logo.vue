  ...
  <nuxt-link to="/">
    <div class="logoWrapper">
      <svg
        ...
        x="0px"
        y="0px"
        viewBox="0 0 351.2 100.6"
        style="enable-background:new 0 0 351.2 100.6;"
        xml:space="preserve"
      >
        <style type="text/css">
          .st0 {
        ...
        <g>
          ...
          <g class="st0">
            <g>
              <path
                class="st1"
                :style="{ fill: $vuetify.theme.dark ? '#00b566' : '#004d40' }"
                d="M120.6,61.4c0,9.8,0,19.5,0,30.2c-4.7,0.4-9.9,0.8-16.6,1.4c-1.2-28.7-2.4-56.9-3.6-84.8
              ...
              <path
                class="st1"
                :style="{ fill: $vuetify.theme.dark ? '#00b566' : '#004d40' }"
                d="M166.1,57.6c-1.2-14.9-2.4-30.4-3.8-45.8c-0.5-5,0.2-8.3,6.4-7.7c6.9,0.6,14,0.1,20.7,1.5
              ...
              <path
                class="st1"
                :style="{ fill: $vuetify.theme.dark ? '#00b566' : '#004d40' }"
                d="M1.1,11.2C0.5,8.8,2,6.3,4.4,5.8C22,2.1,17.3,5.8,24.3,25.2c2.6,7.2,2.9,15.2,4.7,22.7c0,0,0,0.1,0,0.1
              ...
              <path
                class="st1"
                :style="{ fill: $vuetify.theme.dark ? '#00b566' : '#004d40' }"
                d="M282.9,94.4c-2.8,0.4-5.7,0.8-8.7,1.4c-6,1.2-9.8-0.8-10.6-7.1c-1.6-12.6-11.4-7.2-18.2-8.3
              ...
              <path
                class="st1"
                :style="{ fill: $vuetify.theme.dark ? '#00b566' : '#004d40' }"
                d="M296.5,68.3c-1.8,4-3.7,7.9-5.9,12.7c-13.8-27.2-2.2-60.1,21.8-69c8.1-3,14.4-0.3,19.9,4.4
              ...
              <path
                class="st1"
                :style="{ fill: $vuetify.theme.dark ? '#00b566' : '#004d40' }"
                d="M76,92.2c0-28.9,0-57.2,0-85.7c2.1-0.4,3.2-0.7,4.2-0.8c12.4-0.9,12.6-0.6,12.7,11.5
      ...
      <!-- <Img
        :src="
          $vuetify.theme.dark
            ? require('~/assets/logo_long_secondary.png?resize&size=178')
            : require('~/assets/logo_long_primary.png?resize&size=178')
        "
        :placeholder="
          $vuetify.theme.dark
            ? require('~/assets/logo_long_secondary.png?lqip')
            : require('~/assets/logo_long_primary.png?lqip')
        "
        alt="Logo"
      /> -->
    </div>
