...
interface RegUserValidateObjectI {
  Name: true | string[];
  Company: true | string[];
  Email: true | string[];
  Password: true | string[];
  ConfPass: true | string[];
}

interface RegUserErrorObjectI {
  Name?: true | string[];
  Company?: true | string[];
  Email?: true | string[];
  Password?: true | string[];
  ...
  if (Object.keys(error).length !== 0) {
    ...
    genSalt(10, (err: any, salt: any) => {
      if (err) {
        ...
        // => hashing password
        hash(UserInfo.Password, salt, (err: any, hash: any) => {
          if (err) {
...
//         compare(Params.Password, user[0].Password).then(result => {
//           if (!result) {
//             // wrong password
...
//         // user exists
//         // => check password
//         compare(params.Password, user.Password).then(result => {
//           if (!result) {
//             // wrong password
